...
import com.example.inventoryapp.data.OrderContract.OrderEntry;
import com.example.inventoryapp.data.ProductContract.ProductEntry;
import com.example.inventoryapp.data.SupplierContract.SupplierEntry;
...
public class InventoryInstrumentedTest extends ProviderTestCase2<InventoryProvider> {
    ...
    protected void setUp() throws java.lang.Exception {
        ...
        valuesOrder.put(OrderEntry.COLUMN_ORDER_VENDOR_ID, "example@ciandt.com");
